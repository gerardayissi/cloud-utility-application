...
mvn -Pdataflow-runner compile exec:java \
      ...
      --channel=ESBCRS.LB.SVRCONN \
      --port=2024 \
      --outputPubsubTopic=projects/tst1-integration-3ca6/topics/create_order_ce \
      --deadletterPubsubTopic=projects/tst1-integration-3ca6/topics/deadletter \
      --businessInterface=create_order \
      --patternFullName=create_order_ce \
      --tbUser=admin@tbi.com \
      --autoscalingAlgorithm=THROUGHPUT_BASED \
      --workerMachineType=n1-standard-2 \
      --enableStreamingEngine=true \
...
mvn -Pdataflow-runner compile exec:java \
      ...
      --channel=ESBCRS.LB.SVRCONN \
      --port=2024 \
      --outputPubsubTopic=projects/tst1-integration-3ca6/topics/create_order_presale \
      --deadletterPubsubTopic=projects/tst1-integration-3ca6/topics/deadletter \
      --businessInterface=create_order \
      --patternFullName=create_order_presale \
      --tbUser=admin@tbi.com \
      --autoscalingAlgorithm=THROUGHPUT_BASED \
      --workerMachineType=n1-standard-2 \
      --enableStreamingEngine=true \
